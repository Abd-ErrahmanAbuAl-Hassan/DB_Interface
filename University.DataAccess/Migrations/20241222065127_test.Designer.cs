...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DepartmentFaculty", b =>
                {
                    ...
                    b.HasKey("DepartmentsDepartmentId", "FacultiesFacultyId");

                    b.HasIndex("FacultiesFacultyId");

                    b.ToTable("DepartmentFaculty");
                });
            ...
            modelBuilder.Entity("University.Entities.Models.Course", b =>
                {
                    b.Property<string>("CourseId")
                        .HasMaxLength(6)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("University.Entities.Models.Department", b =>
                {
            ...
            modelBuilder.Entity("University.Entities.Models.DepartmentCourse", b =>
                {
                    b.Property<int>("DepartmentId")
                        .HasColumnType("int")
                        .HasColumnName("Department_id");
            ...
            modelBuilder.Entity("University.Entities.Models.Employing", b =>
                {
            ...
            modelBuilder.Entity("University.Entities.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("University.Entities.Models.Faculty", b =>
                {
                    b.Property<int>("FacultyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("University.Entities.Models.Staff", b =>
                {
                    b.Property<int>("EmployeeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("University.Entities.Models.Student", b =>
                {
                    b.Property<int>("StudentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("University.Entities.Models.Teaching", b =>
                {
                    b.Property<int>("StaffId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DepartmentFaculty", b =>
                {
                    b.HasOne("University.Entities.Models.Department", null)
                        .WithMany()
                        .HasForeignKey("DepartmentsDepartmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("University.Entities.Models.Faculty", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Teaching", b =>
                {
                    b.HasOne("University.Entities.Models.Course", null)
                        .WithMany()
                        .HasForeignKey("CourseId")
                        .IsRequired()
                        .HasConstraintName("Teach_C_FK");

                    b.HasOne("University.Entities.Models.Staff", null)
                        .WithMany()
            ...
            modelBuilder.Entity("University.Entities.Models.DepartmentCourse", b =>
                {
                    b.HasOne("University.Entities.Models.Course", "Course")
                        .WithMany("DepartmentCourses")
                        .HasForeignKey("CourseId")
                        .IsRequired()
                        .HasConstraintName("DepartmentCourses_FK");

                    b.HasOne("University.Entities.Models.Department", "Department")
                        .WithMany("DepartmentCourses")
            ...
            modelBuilder.Entity("University.Entities.Models.Employing", b =>
                {
                    ...
                    b.HasOne("University.Entities.Models.Staff", "Employee")
                        .WithMany("Employings")
                        .HasForeignKey("EmployeeId")
                        .IsRequired()
                        .HasConstraintName("Employing_S_FK");

                    b.HasOne("University.Entities.Models.Faculty", "Faculty")
                        .WithMany("Employings")
            ...
            modelBuilder.Entity("University.Entities.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("University.Entities.Models.Student", "Student")
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("University.Entities.Models.Teaching", b =>
                {
                    ...
                    b.HasOne("University.Entities.Models.Staff", "Staff")
                        .WithMany("Teaching")
                        .HasForeignKey("StaffId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
